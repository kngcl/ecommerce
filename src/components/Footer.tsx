        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Your trusted destination for premium products. We curate the finest selection of electronics, fashion, and lifestyle products.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400 text-sm">support@Charles.com</span>
              </div>
            </div>
          </div>
        </div>
